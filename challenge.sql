...
--Query--
SELECT email
FROM public.data_table INNER JOIN public.email_table
ON public.data_table.join_id = public.email_table.join_id
WHERE BITAND(public.data_table.column_1, 1) = 0
AND public.data_table.column_2 < public.data_table.column_1
AND (public.data_table.column_3 - 1) % 10 = 0;
